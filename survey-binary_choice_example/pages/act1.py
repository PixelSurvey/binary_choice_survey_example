...
dash.register_page(__name__, path_template="/act1/<task_number>", name='1_binary_choice')
...
def task_content_generator(data):
    """Generate binary choice content for current task"""
    
    # Unpack the task data
    alt1_att1_property_url, alt1_att2_price, alt2_att1_property_url, alt2_att2_price = data
    ...
    card_alternative_1 = dbc.Card(
            ...
            children=[
                dbc.CardHeader(
                    html.H4(f"Property #1", className="card-title")
                )
                
                
                ,
                dbc.CardImg(src=f"{alt1_att1_property_url}", top=True)
                    ...
                    dbc.Row(children=[
                        ...
                        dbc.Col(
                            dbc.Card([
                                ...
                                dbc.CardBody(
                                    dcc.Markdown(f"**{alt1_att2_price}** €"), 
                                    style={"fontSize": "20px"}
                                )
                            ])
                        )
    ...
    card_alternative_2 = dbc.Card(
            ...
            children=[
                dbc.CardHeader(
                    html.H4(f"Property #2", className="card-title")
                )
                
                
                ,
                dbc.CardImg(src=f"{alt2_att1_property_url}", top=True)
                    ...
                    dbc.Row(children=[
                        ...
                        dbc.Col(
                            dbc.Card([
                                ...
                                dbc.CardBody(
                                    dcc.Markdown(f"**{alt2_att2_price}** €"), 
                                    style={"fontSize": "20px"}
                                )
                            ])
                        )
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        ...
                        # Question text
                        html.Span(
                            "Which property would you prefer to purchase?",
                            style={
                                "fontWeight": "bold",
                                "color": "darkblue",
                                "fontSize": "22px",
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            dcc.Markdown(
                                """### Experiment: Binary Choice Tasks - Custom Design

You will see pairs of properties with location and amenity information. Choose your preference.
""",
                                style={
                                    "fontSize": "16px",
                                    "lineHeight": "1.6",
...
@callback(
    ...
    Input("binary-choice-1-response", "value"),
...
@callback(
    ...
    State('user-store', 'data'),
    State("last_task_resp_act1", "data"),
    State('binary-choice-1-response', 'value'),
    prevent_initial_call=True
)
